"""
Reactive VTuber Orchestrator - Simplified character-driven system
Handles external inputs and generates responses based on character configuration
"""
...
class ReactiveOrchestrator:
    ...
    async def _generate_llm_response(
        ...
        if include_conversation_history:
            ...
            conversation_context = self._format_conversation_history(recent_turns)
